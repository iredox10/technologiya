    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-3xl mx-auto mb-12">
        ...
        <form onSubmit={handleSearch} className="relative">
          ...
          <button
            type="submit"
            className="mt-4 w-full md:w-auto md:absolute md:right-2 md:top-2 md:mt-0 px-8 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors"
          >
            Nema
          </button>
        </form>
          ...
          <>
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">
                An samu {results.length} {results.length === 1 ? 'sakamako' : 'sakamakon'} don "{query}"
              </h2>
            </div>
